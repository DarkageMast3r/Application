...
// Source: C:\Users\arjan\Documents\Git\temp\Application\ZorgTechCatalogus\pkg\database\db.go
...
func (m *MockDatabase) Create(value interface{}) Database {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseMockRecorder) Find(dest interface{}, conds ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m *MockDatabase) Save(value interface{}) Database {
	m.ctrl.T.Helper()
...
func (m *MockDatabase) Updates(value interface{}) *gorm.DB {
	m.ctrl.T.Helper()
...
func (mr *MockDatabaseMockRecorder) Updates(value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Updates", reflect.TypeOf((*MockDatabase)(nil).Updates), value)
}
